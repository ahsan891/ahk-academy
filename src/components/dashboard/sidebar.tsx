...
const adminLinks: SidebarItem[] = [
  ...
  { label: "Grammar", href: "/admin/grammar", icon: <BookOpen size={20} /> },
...
const teacherLinks: SidebarItem[] = [
  ...
  { label: "Grammar", href: "/teacher/grammar", icon: <BookOpen size={20} /> },
...
const studentLinks: SidebarItem[] = [
  ...
  { label: "Grammar", href: "/student/grammar", icon: <Brain size={20} /> },
